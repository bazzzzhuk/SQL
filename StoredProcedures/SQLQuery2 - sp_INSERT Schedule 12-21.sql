--SQLQuery2 - sp_INSERT Schedule 12-21.sql
...
--	DECLARE @number_of_lesson_1		AS TINYINT	=	(SELECT number_of_lessons FROM Disciplines WHERE)
--END
CREATE OR ALTER PROCEDURE sp_InsertSchedule1221
	 @group_name				AS NCHAR(10)
...
BEGIN
	...
	DECLARE @previous_week_present  AS BIT = 0;
