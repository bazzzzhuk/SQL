...
DELETE FROM Schedule WHERE [group] = 10
...
EXEC sp_InsertScheduleStacionar N'PV_212', N'%ADO.NET%', N'Олег', N'2025-01-20';
EXEC sp_1221_InsertSchedule N'PV_521', N'%ADO.NET%', N'Олег', N'2025-02-07', N'%Hardware-PC%', N'Свищев', N'2025-02-20';
EXEC sp_SelectScheduleFor		N'PV_212';
